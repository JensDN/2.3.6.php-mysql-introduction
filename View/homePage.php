...
<head>
    ...
    <title>Home - Jens MySQL Project</title>
    ...
    <div class="container"><a class="navbar-brand logo" href="?page=homepage">Jens MySQL Project</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item" role="presentation"><a class="nav-link active" href="?page=homepage">Home</a></li>
...
<div class="highlight-clean" style="min-width: 0px;min-height: 671px;">
    <div class="container">
        <div class="intro">
            <h2 class="text-center">Welcome</h2>
            <p class="text-center">My go @ MySQL, some proper MVC and staying sane.</p>
        </div>
        <div class="buttons"><a class="btn btn-primary" role="button" href="?page=login">Login</a><a class="btn btn-light" role="button" href="?page=register">Register</a></div>
    </div>
</div>
