...
<head>
    ...
    <title>About Us - Jens MySQL Project</title>
    ...
    <div class="container"><a class="navbar-brand logo" href="?page=homepage">Jens MySQL Project</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item" role="presentation"><a class="nav-link active" href="?page=profile">About you</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="profile-img">
                                <img src="https://belikebill.ga/billgen-API.php?default=1&name=jens&sex=m" style="max-block-size: 200px" alt=""/>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="profile-work">
                                <p>WORK LINK</p>
                                <a href=<?php echo $student->getLinkedin() ?> >Linkedin</a><br/>
                                <a href=<?php echo $student->getGithub() ?>>Github</a><br/>
                            </div>
                        </div>
                        <div class="col-md-8">
